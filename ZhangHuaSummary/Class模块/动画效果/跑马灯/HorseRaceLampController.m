//
//  HorseRaceLampController.m
//  ZhangHuaSummary
//
//  Created by 张华 on 2019/2/25.
//  Copyright © 2019年 zhanghua0221. All rights reserved.
//

#import "HorseRaceLampController.h"
#import "LMJScrollTextView.h"

@interface HorseRaceLampController ()
{
...
@implementation HorseRaceLampController
...
- (void)viewDidLoad {
    ...
    //往返滚动
    [self addLabelWithFrame:CGRectMake(10, kNavAndStatusHeight+30, 400, 20) text:@"往返滚动（Back and forth）"];
    
    _scrollTextView1_1 = [[LMJScrollTextView alloc] initWithFrame:CGRectMake(10, kNavAndStatusHeight+50, 300, 30) textScrollModel:LMJTextScrollWandering direction:LMJTextScrollMoveLeft];
    ...
    _scrollTextView1_2 = [[LMJScrollTextView alloc] initWithFrame:CGRectMake(10, kNavAndStatusHeight+85, 300, 30) textScrollModel:LMJTextScrollWandering direction:LMJTextScrollMoveLeft];
    ...
    //向左，连续滚动
    [self addLabelWithFrame:CGRectMake(10, kNavAndStatusHeight+135, 400, 20) text:@"向左，连续滚动（left，continuous）"];
    
    _scrollTextView2 = [[LMJScrollTextView alloc] initWithFrame:CGRectMake(10, kNavAndStatusHeight+155, 300, 30) textScrollModel:LMJTextScrollContinuous direction:LMJTextScrollMoveLeft];
    ...
    //向右，连续滚动
    [self addLabelWithFrame:CGRectMake(10, kNavAndStatusHeight+185, 400, 20) text:@"向右，连续滚动（right，continuous）"];
    
    _scrollTextView3 = [[LMJScrollTextView alloc] initWithFrame:CGRectMake(10, kNavAndStatusHeight+205, 300, 30) textScrollModel:LMJTextScrollContinuous direction:LMJTextScrollMoveRight];
    ...
    //向左，间断滚动
    [self addLabelWithFrame:CGRectMake(10, kNavAndStatusHeight+255, 400, 20) text:@"向左，间断滚动（left，intermittent）"];
    
    _scrollTextView4 = [[LMJScrollTextView alloc] initWithFrame:CGRectMake(10, kNavAndStatusHeight+275, 300, 30) textScrollModel:LMJTextScrollIntermittent direction:LMJTextScrollMoveLeft];
    ...
    //向右，间断滚动
    [self addLabelWithFrame:CGRectMake(10, kNavAndStatusHeight+305, 400, 20) text:@"向右，间断滚动（right，intermittent）"];
    
    _scrollTextView5 = [[LMJScrollTextView alloc] initWithFrame:CGRectMake(10, kNavAndStatusHeight+325, 300, 30) textScrollModel:LMJTextScrollIntermittent direction:LMJTextScrollMoveRight];
    ...
    //向左，控件外开始滚动
    [self addLabelWithFrame:CGRectMake(10, kNavAndStatusHeight+375, 400, 20) text:@"向左，控件外开始滚动（left，outside start）"];
    
    _scrollTextView6 = [[LMJScrollTextView alloc] initWithFrame:CGRectMake(10,kNavAndStatusHeight+395, 300, 30) textScrollModel:LMJTextScrollFromOutside direction:LMJTextScrollMoveLeft];
    ...
    //向右，控件外开始滚动
    [self addLabelWithFrame:CGRectMake(10, kNavAndStatusHeight+425, 400, 20) text:@"向右，控件外开始滚动（right，outside start）"];
    
    _scrollTextView7 = [[LMJScrollTextView alloc] initWithFrame:CGRectMake(10, kNavAndStatusHeight+445, 300, 30) textScrollModel:LMJTextScrollFromOutside direction:LMJTextScrollMoveRight];
