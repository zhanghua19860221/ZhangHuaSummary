...
@interface RunDisplayController (){
    UIButton * _RegisterBtn;
}

@end

@implementation RunDisplayController
...
- (void)viewDidLoad {
    ...
    [_RegisterBtn addTarget:self action:@selector(clickAnimation) forControlEvents:UIControlEventTouchUpInside];
